 			 ...
 			 <div class="row">
				<div class="col-lg-3" >
						<nav class="nav flex-column">
						  <a class="nav-link active" href="#none" onclick="getCateBestBook(1)">IT/모바일</a>
						  <a class="nav-link" href="#none" onclick="getCateBestBook(2)">소설/시/희곡</a>
						  <a class="nav-link" href="#none" onclick="getCateBestBook(3)">어린이</a>
						  <a class="nav-link" href="#none" onclick="getCateBestBook(4)">에세이</a>
						  <a class="nav-link" href="#none" onclick="getCateBestBook(5)">종교</a>			
						</nav>
				</div>
				<div class="col-lg-9" >
