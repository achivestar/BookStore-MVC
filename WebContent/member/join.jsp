			...
			<div class="jumbotron col-md-8" style="padding-top:20px;width:100%;margin:0 auto ">
				<form method="post"  action="./Board.do?command=memberJoinAction" enctype="multipart/form-data" name="joinForm"  id="joinForm" onsubmit="return checkForm()">
							...
							<div class=" form-group btn-group col-md-12"  >
								...
								<input type="text" class="form-control" placeholder="아이디"  name="userID"  id="userID" maxlength="20"  onblur="idCheck()"/>
						...
						<div class="form-group" style="text-align:center">
						     ...
						     <div class="form-group btn-group col-md-12"  >
								<input type="text"  class="form-control "  name="zipNum" placeholder="우편번호"  readonly>
								<input type="button" class="btn btn-info col-form-label-sm"onclick="openZipSearch()" value="우편번호 찾기"><br>
							</div>
						    <div class="form-group btn-group col-md-12 ">
						    	<input type="text"  name="addr1" class="form-control  col-form-label-sm" id="addr1" placeholder="도로명주소"  readonly>
						    	<div class="invalid-feedback" >
							     	  	주소를 입력해 주세요.(상세주소가 있을경우 반드시 기입해주세요)
							      </div>
						     </div>	
					       <div class="form-group btn-group col-md-12 ">
					    	<input type="text"  name="addr2" class="form-control col-form-label-sm"  placeholder="상세주소">
					     </div>
					    	

					   <div class="form-group btn-group col-md-12" >
							  <input type="text" class="form-control col-form-label-sm"  name="phone1"  id="phone1" placeholder="연락번호" maxlength="4"  />
							-<input type="text" class="form-control col-form-label-sm"  name="phone2"  id="phone2" maxlength="4"  />
							-<input type="text" class="form-control col-form-label-sm"  name="phone3"  id="phone3" maxlength="4" />
							<div class="invalid-feedback" >
